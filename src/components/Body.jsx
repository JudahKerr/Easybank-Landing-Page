...
function Body() {
  return (
    <div className="bg-Light-Grayish-Blue flex md:justify-center justify-center md:mx-0 mx-auto md:p-12 w-7/8 md:text-left text-center overflow-hidden">
      <div className="flex flex-justify-center items-center flex-wrap flex-1 flex-col md:pt-60 md:pl-44 mx-auto p-12 md:p-0">
        <h1 className="text-7xl text-Dark-Blue  font-Public-Sans h-24 md:self-end md:w-[650px] leading-tight w-screen">
          Next generation digital banking
        </h1>
        <p className="text-Grayish-Blue font-Public-Sans md:mt-32 mt-72 md:w-[525px] w-screen text-xl self-start leading-normal">
