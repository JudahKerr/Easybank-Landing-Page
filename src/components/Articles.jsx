    ...
    <div className="bg-gray-100 -mt-[170px] pt-36 pb-36 overflow-hidden">
      ...
      <div className="grid md:grid-cols-4 md:grid-rows-none grid-cols-1 grid-rows-4 md:pl-44 md:pr-44 gap-10 md:w-auto w-3/4 md:mx-0 mx-auto">
        <div className="grid grid-cols-1  bg-white rounded-lg pb-12">
          <img src={Currency} alt="currency"className="w-full h-[260px] md:mx-0 mx-auto rounded-lg"></img>
      ...
      forced to only receive money in a single …</p>
        ...
        <div className="grid grid-cols-1 auto-rows-3 bg-white rounded-lg pb-12">
          <img src={Restaurant} alt="restaurant" className=" h-auto  rounded-lg"></img>
      ...
      you …</p>
        ...
        <div className="grid grid-cols-1 auto-rows-3 bg-white rounded-lg pb-12">
          <img src={Plane} alt="plane" className="w-94 h-auto rounded-lg"></img>
          <p className="text-Grayish-Blue font-Public-Sans  text-md self-start leading-normal mt-8 ml-8">By Wilson Hutton</p>
      ...
      while you’re abroad. We’ll even show you …</p>
        ...
        <div className="grid grid-cols-1 auto-rows-3 bg-white rounded-lg pb-12">
          <img src={Confetti} alt="confetti" className="w-94 h-auto rounded-lg"></img>
          <p className="text-Grayish-Blue font-Public-Sans  text-md self-start leading-normal mt-8 ml-8">By Claire Robinson</p>
