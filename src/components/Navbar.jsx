...
function Navbar() {
  ...
  return (
    <div className="flex bg-white items-center md:justify-evenly text-2xl font-Public-Sans lg:mx-44 mx-2 h-24 z-20">
      <img
        src={Logo}
        useRef={logo}
        alt="logo"
      ...
      >
        <ul
          ref={mobileMenu}
          className=" bg-white mt-[500px] w-[80%] ml-20 border-solid border-black border-2 flex px-8 flex-col items-center justify-center transition-all ease-in duration-150"
        >
